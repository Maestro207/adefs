...
export default function File({
	...
	return (
		<div className="bg-white p-8 flex flex-col break-words wrap rounded-2xl border-[1px] max-w-[90%] md:max-w-[40%] lg:max-w-[50%] text-balance border-gray-200 hover:border-gray-800 transition-all ease">
